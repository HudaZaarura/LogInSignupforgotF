...
public class LoginFragment extends Fragment {
    ...
    public void onStart() {
        ...
        tvForgotPassLink= getView().findViewById(R.id.forgotpassword);
        ...
        btnLogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                fsb.getAuth().signInWithEmailAndPassword(username, password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    @Override
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if(task.isSuccessful()){
                            ...
                            Toast.makeText(getActivity(),"Failed to log in! check user or password and try again!", Toast.LENGTH_SHORT).show();
                        }
